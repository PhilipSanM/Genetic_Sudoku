...
class GeneticAlgorithm:
                            ...
                            for toChange, toChangeA in zip(indicesRepetidos, indicesRepetidosA):
                                ...
                                if prohibidos[toChange]== 0 and prohibidosAlterno[toChangeA]== 0:
                                    ...
                                    if self.checkNumbersInBothSubblocksNowFast(num1, num2, subblock, subblockAlterno, individuo.subBlockSize):
                                        ...
                                        change = True
                                        print("=========================================================")
                                        print(f"Se hizo un cambio en el subblock {index} y {indiceSBA}")
                                        print(f"Se intercambiaron {num1} y {num2}")
                                        print(f"En las posiciones {toChange} y {toChangeA}")
                                        print(f"En las filas {actualRow} y {actualRowAlterno}")
                                        print(f"Los prohibidos son {prohibidos} y {prohibidosAlterno}")
                                        print(f"======================================================")
    ...
    def sudoku_ga(self, board, populationSize, generaciones, pc1, pc2, pm1, pm2):
        ...
        for i in range(generaciones):
            ...
            # self.mostrarPuzzles(population,"Despues de cruzar")
            ...
            # self.mostrarPuzzles(population,"Despues de mutar")

            self.columnLocalSarch(population)


            # self.mostrarPuzzles(population,"Despues de actualizar columnas")

            # self.subblockLocalSearch(population)


            # self.mostrarPuzzles(population,"Despues de actualizar subblocks")
